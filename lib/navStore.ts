...
const DEMO_PROJECTS: NavItem[] = [
  { id: 'Noorderlicht Media', label: 'Noorderlicht Media', href: '/demo/projects/' + encodeURIComponent('Noorderlicht Media'), color: '#B0C6EB' },
  { id: 'Kaap Studio',        label: 'Kaap Studio',        href: '/demo/projects/' + encodeURIComponent('Kaap Studio'),        color: '#D8935B' },
]
