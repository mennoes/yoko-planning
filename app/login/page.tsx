    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg-base)' }}>
      <div style={{ width: 380, padding: '40px 36px', background: 'var(--bg-card)', borderRadius: 16, border: '1px solid var(--border)', boxShadow: '0 20px 60px rgba(0,0,0,0.15)' }}>
        ...
        <div style={{ marginBottom: 28, textAlign: 'center' }}>
          <svg width="80" height="14" viewBox="0 0 323 57" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ color: 'var(--sup-yellow)' }}>
          ...
          <div style={{ fontSize: 8, fontWeight: 700, color: 'var(--sup-yellow)', letterSpacing: '0.28em', textTransform: 'uppercase', marginTop: 5 }}>PLANNING</div>
        </div>
