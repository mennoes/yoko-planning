    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg-base)' }}>
      <div style={{ width: 380, padding: '40px 36px', background: 'var(--bg-card)', borderRadius: 16, border: '1px solid var(--border)', boxShadow: '0 20px 60px rgba(0,0,0,0.15)' }}>
        ...
        <div style={{ marginBottom: 28, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <svg width="120" height="21" viewBox="0 0 323 57" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ color: 'var(--sup-yellow)', display: 'block' }}>
          ...
          <div style={{ fontSize: 12, fontWeight: 700, color: 'var(--sup-yellow)', letterSpacing: '0.32em', textTransform: 'uppercase', marginTop: 8 }}>PLANNING</div>
        </div>
...
function ThemePicker() {
  ...
  return (
    <div style={{ marginTop: 18, paddingTop: 16, borderTop: '1px solid var(--border)' }}>
      <div style={{ fontSize: 11, fontWeight: 600, color: 'var(--text-muted)', textAlign: 'center', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 8 }}>Weergave</div>
