...
// DEMO-VARIANT van app/activity/page.tsx — de pagina zelf heeft geen
// Supabase-afhankelijkheid (puur lib/activityLog.ts, localStorage), dus
// dit is een 1-op-1 kopie. activityLog.ts is zelf demo-aware (aparte
// 'yoko-demo-activity'-key op /demo), dus verder niets aan te passen.
