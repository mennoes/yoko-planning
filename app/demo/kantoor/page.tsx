...
// DEMO-VARIANT van app/kantoor/page.tsx — deze pagina heeft geen Supabase-
// afhankelijkheid (puur lokale React-state + localStorage), dus de fork is
// vrijwel een 1-op-1 kopie. Twee verschillen met het origineel:
//   1. DEFAULT_DATA is volledig verzonnen (nep adres, KvK, IBAN, wifi-
//      wachtwoorden, alarmcode, etc.) — nooit echte Studio Yoko-gegevens
//      tonen op de publieke demo.
//   2. STORAGE_KEY heeft een '-demo' suffix zodat een demo-bezoeker nooit
//      per ongeluk de echte localStorage-entry van een ingelogde gebruiker
//      in dezelfde browser leest of overschrijft.
