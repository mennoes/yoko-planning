...
// Vaste, lokale lijst i.p.v. de registry-backed BOARD_NAMES uit
// boardStore.ts — de demo kent maar twee (verzonnen) borden en mag nooit
// de echte, Supabase-backed bordenlijst raadplegen.
const BOARD_NAMES = DEMO_BOARD_IDS
...
export default function PlanningPage() {
  ...
  useEffect(() => {
    ...
    // DEMO: geen Supabase-realtime, geen remote-pull-polling, geen
    // vacation-lookup — alles blijft lokaal (localStorage) zoals de rest
    // van deze pagina.
