...
// DEMO-VARIANT van app/todos/page.tsx — zelfde component, databron
// vervangen door verzonnen fixtures i.p.v. de echte borden/team/todo's.
// Geen Supabase-sync. Zie app/demo/planning/page.tsx voor hetzelfde patroon.
import initialData from '@/data/demoTodos.json'
